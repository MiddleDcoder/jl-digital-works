...
// Use public/ path so the browser can preload the LCP image via <link rel="preload">
// (Vite module imports get hashed URLs that can't be preloaded from HTML)
...
export const Hero = () => {
  ...
  return (
    <>
      {/* Skeleton placeholder – visible until hero image finishes loading */}
