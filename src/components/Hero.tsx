  ...
  return (
    ...
    >
      <div className="container-custom mx-auto px-4 md:px-8 relative z-10" itemScope itemType="https://schema.org/Person">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <h1
              id="hero-heading"
              className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 animate-in animate-delay-100 leading-[1.1]"
            ...
            <div className="flex flex-wrap gap-3 mb-8 animate-in animate-delay-250 justify-center lg:justify-start">
              ...
              <a
                href="#automation"
                className="flex items-center gap-2 px-4 py-2 bg-card border border-border rounded-full text-sm font-medium text-muted-foreground hover:border-primary/50 hover:text-foreground transition-all cursor-pointer"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10 animate-in animate-delay-300 justify-center lg:justify-start">
              <a
                href="#portfolio"
                className="inline-flex items-center justify-center gap-3 px-7 py-4 bg-primary text-primary-foreground rounded-full font-semibold text-lg hover:opacity-90 transition-all hover:scale-105 group shadow-lg shadow-primary/25"
              >
                View My Work
              ...
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 px-7 py-4 bg-secondary text-foreground rounded-full font-semibold text-lg hover:bg-secondary/80 transition-all border border-border"
              >
          ...
          <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end animate-in animate-delay-200">
            ...
            <div className="relative z-10">
              <img
                src={photo}
                alt="Jhun Lorenz A. Asna - Freelance Web Systems Consultant"
                loading="eager"
                fetchPriority="high"
                decoding="async"
      ...
      <button
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce hidden md:block cursor-pointer hover:opacity-70 transition-opacity"
