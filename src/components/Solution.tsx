...
export const Solution = () => {
  return (
    <section id="solution" className="section-padding bg-background" aria-labelledby="solution-heading">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {additionalServices.map((service, index) => (
              <a
                key={index}
                href={service.href}
                className="group relative flex flex-col p-6 bg-card rounded-2xl border border-border hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300"
              >
